    ...
    public partial class InitialCommit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LinkA = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LinkB = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecureLinks_A", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecureLinks_A_Employees_LinkA",
                        column: x => x.LinkA,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecureLinks_A_HomeAddresses_LinkB",
                        column: x => x.LinkB,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecureLinks_A_LinkA",
                table: "SecureLinks_A",
                column: "LinkA",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SecureLinks_A_LinkB",
                table: "SecureLinks_A",
                column: "LinkB",
                unique: true);
